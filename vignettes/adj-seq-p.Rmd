...
ans %>%
  select(Analysis, Hypothesis, 
         `Sequantial p-values of Weighted Bonferroni`, `Adjusted-sequantial p-values of Weighted Bonferroni`,
         `Sequantial p-values of WPGSD`, `Adjusted-sequantial p-values of WPGSD`
         ) %>% 

  gt::gt() %>%
  gt::tab_spanner(
    label = "Weighted Bonferroni",
    columns = c(`Sequantial p-values of Weighted Bonferroni`, `Adjusted-sequantial p-values of Weighted Bonferroni`)
  ) %>% 
  gt::tab_spanner(
    label = "WPGSD",
    columns = c(`Sequantial p-values of WPGSD`, `Adjusted-sequantial p-values of WPGSD`)
  ) %>% 
  gt::tab_style_body(
  ...
  gt::tab_header(title = "(Adjusted-) sequantial p-values",
                 subtitle = "Multiple populations") # %>% gt::as_latex()
```
