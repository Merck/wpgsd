...
- event:
  ...
  Event count of each hypothesis at each analysis, including event count
  of the intersection of hypotheses. It contains 4 columns: `H1`, `H2`,
  `Analysis`, `Event`. `H1` needs to be listed as 1, 2, 3, etc. as
  numbers.
